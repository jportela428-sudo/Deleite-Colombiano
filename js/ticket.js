...
function generarTicket(pedido) {
    ...
    contenido.innerHTML = `
        ...
        <div class="ticket-footer">
            ...
            ❤️ Gracias por preferir DELEITE COLOMBIANO ❤️
...
Gracias por preferir DELEITE COLOMBIANO ❤️`;
...
function enviarCorreo() {
    ...
    const asunto =
        ...
        `Pedido #${ultimoPedido.numero} - DELEITE COLOMBIANO`;
...
Gracias por preferir DELEITE COLOMBIANO
